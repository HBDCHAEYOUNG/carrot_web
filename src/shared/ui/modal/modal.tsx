...
interface ModalProps {
	onClickCancel: (e: MouseEvent<HTMLDivElement> | MouseEvent<HTMLButtonElement>) => void
		...
		<div className="fixed left-0 top-0 h-full w-full">
			...
			<div className="fixed left-1/2 top-1/2 flex -translate-x-1/2 -translate-y-1/2 flex-col gap-3 rounded-lg bg-white p-6">
				...
				<div className="flex gap-2">
					<button className="w-full rounded-md bg-gray-01 px-4 py-2 text-black flex-center hover:brightness-90" onClick={onClickCancel}>
						<p>취소</p>
					</button>
